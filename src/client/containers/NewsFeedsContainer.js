      ...
      <div style={margin50}>
        <div style={header}>
          <span style={fontSize10}>
            <i style={fontSize14} className="fa fa-jpy" aria-hidden="true"></i>
          </span>
          <span style={topLabel}>{content.labels.newsFeedsContainer.top}</span>
          <span style={divider}></span>
          <span style={newLabel}>{content.labels.newsFeedsContainer.new}</span>
        </div>
